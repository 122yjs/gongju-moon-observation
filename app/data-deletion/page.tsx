  ...
  return (
    <main className="min-h-screen bg-space-950 px-5 py-10 text-slate-100">
      <article className="mx-auto max-w-3xl rounded-3xl border border-space-700 bg-space-800 p-6 shadow-card sm:p-8">
        ...
        <p className="mt-2 text-sm leading-7 text-slate-300">교사 관리 화면에서 <strong>Drive 연결 해제</strong>를 선택하면 중앙 D1의 교사 연결정보·암호화 토큰·학생 QR 설정·하트 기록이 삭제되고 Google OAuth 토큰이 폐기됩니다. 교사 Drive에 저장된 자료와 피드백은 남습니다.</p>
        ...
        <h2 className="mt-7 text-xl font-black">교사 피드백과 하트</h2>
        <p className="mt-2 text-sm leading-7 text-slate-300">교사는 피드백을 빈 값으로 저장하여 삭제할 수 있습니다. 앱에서 관찰 기록을 삭제하면 같은 Sheets 행의 피드백과 중앙 D1의 하트도 삭제됩니다. 반 삭제·Drive 연결 해제 시 해당 범위의 하트가 함께 삭제되며, 참여자는 같은 브라우저에서 하트를 다시 눌러 취소할 수 있습니다. Google Drive나 Sheets에서 직접 지운 자료는 중앙 하트 정리와 자동 연동되지 않으므로 앱의 삭제 기능 또는 연결 해제를 이용해 주세요.</p>
